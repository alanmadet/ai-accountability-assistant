...
class GmailLinkTests(unittest.TestCase):
    def test_prefers_thread_and_selects_connected_account(self):
        url = gmail_web_url(
            "alan+beacon@example.com", "thread-123", "message-456", "id@example.com"
        )
        self.assertEqual(
            url,
            "https://mail.google.com/mail/u/?authuser=alan%2Bbeacon%40example.com#all/thread-123",
        )
    ...
    def test_uses_official_rfc822_search_when_api_ids_are_missing(self):
        ...
        self.assertEqual(
            url,
            "https://mail.google.com/mail/u/?authuser=me%40example.com#search/"
